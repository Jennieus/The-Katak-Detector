...
i.    Reduce the data up to 2010 since it can't handle more than 44k rows of data (Original data has 193792k rows)
...
Build a computational model that can predict the count of frogs for a specific location using multiple datasets, and to validate model on other locations of other countries.
